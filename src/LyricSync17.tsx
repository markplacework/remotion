...
import { LyricSyncScene17, LYRIC_SYNC_17_LAST_FRAME } from "./scenes/LyricSyncScene17";
...
export const LYRIC_SYNC_17_FPS = FPS;
export const LYRIC_SYNC_17_WIDTH = VIDEO_WIDTH;
export const LYRIC_SYNC_17_HEIGHT = VIDEO_HEIGHT;
// No fixed duration requested — natural pacing, ends at the standard
// hold (8s) after the last line.
export const LYRIC_SYNC_17_DURATION = LYRIC_SYNC_17_LAST_FRAME + LYRIC_SYNC_HOLD_FRAMES;

export const LyricSync17: React.FC = () => {
  return (
    <AbsoluteFill>
      <LyricSyncScene17 />
    </AbsoluteFill>
