...
// unhurried pace). Comes out to ~40.5s: Intro (text only, gancho) 4s,
// Editor real (mockup only — logo, descripción, portada, cargar un
// producto, ver todos cargados) 27s, Catálogo publicado (mockup only)
