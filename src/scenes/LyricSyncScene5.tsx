...
// "cosas") — kept exactly as given per instructions, but for lines 10
// and 16 the alignment search only found the tail of the phrase
// ("loco tu forma de ser." / "en el barro..."), so their start times
// were corrected by hand from the real word timestamps of the actual
// first word ("a" / "son") rather than the mismatched word. Line 13
// has no identifiable lead-in for "Me" in the transcript at all (goes
// straight from the prior line into "Tu egoío loco..."), so its
// difflib-found start stands as the closest anchor available. Seconds
...
//   "Y a mi me volvio loco tu forma de ser,"       33.26s ->  998
//   "a mi me vuelve loco tu forma de ser."         37.64s -> 1129 (corrected)
...
//   "a mi me volvio loco tu forma de ser."         53.68s -> 1610
...
export const BUBBLES: DarkBubble[] = [
  ...
  { from: "me", text: "Y a mi me volvio loco tu forma de ser,", timestamp: "22:18", atFrame: 998 },
  { from: "me", text: "a mi me vuelve loco tu forma de ser.", timestamp: "22:18", atFrame: 1129 },
  ...
  { from: "me", text: "a mi me volvio loco tu forma de ser.", timestamp: "22:20", atFrame: 1610 },
